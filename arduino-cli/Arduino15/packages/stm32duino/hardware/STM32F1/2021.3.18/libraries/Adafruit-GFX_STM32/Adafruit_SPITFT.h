...
/*!
  @brief  Adafruit_SPITFT is an intermediary class between Adafruit_GFX_STM32
          ...
          the comments.
*/
class Adafruit_SPITFT : public Adafruit_GFX_STM32 {
  ...
  public:
    ...
    */
    ...
    using        Adafruit_GFX_STM32::drawRGBBitmap; // Check base class first
