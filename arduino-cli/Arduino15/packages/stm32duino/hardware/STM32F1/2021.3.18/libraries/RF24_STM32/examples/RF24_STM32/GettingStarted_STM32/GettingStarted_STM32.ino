...
#define display_OLED_DC       PA13
#define display_OLED_CS       PA14
#define display_OLED_RESET    -1
Adafruit_SSD1306_STM32 display(display_SCREEN_WIDTH, display_SCREEN_HEIGHT, &SPI_3, display_OLED_DC, display_OLED_RESET, display_OLED_CS);
