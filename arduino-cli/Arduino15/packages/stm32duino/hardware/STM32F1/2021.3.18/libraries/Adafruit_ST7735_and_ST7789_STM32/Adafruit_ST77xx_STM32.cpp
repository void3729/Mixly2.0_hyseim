...
*/
/**************************************************************************/
Adafruit_ST77xx_STM32::Adafruit_ST77xx_STM32(uint16_t w, uint16_t h, int8_t cs, int8_t dc,
...
*/
/**************************************************************************/
Adafruit_ST77xx_STM32::Adafruit_ST77xx_STM32(uint16_t w, uint16_t h, SPIClass *spiClass,
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::displayInit(const uint8_t *addr) {
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::begin(uint32_t freq) {
  if (!freq) {
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::commonInit(const uint8_t *cmdList) {
  begin();
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::setAddrWindow(uint16_t x, uint16_t y, uint16_t w,
                                    uint16_t h) {
  x += _xstart;
  y += _ystart;
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::setRotation(uint8_t m) {
  uint8_t madctl = 0;
...
*/
/**************************************************************************/
void Adafruit_ST77xx_STM32::setColRowStart(int8_t col, int8_t row) {
  _colstart = col;
  _rowstart = row;
}
 ...
 */
/**************************************************************************/
void Adafruit_ST77xx_STM32::enableDisplay(boolean enable) {
 ...
 */
/**************************************************************************/
void Adafruit_ST77xx_STM32::enableTearing(boolean enable) {
...
/*
 ...
 uint8_t Adafruit_ST77xx_STM32::spiread(void) {
 uint8_t r = 0;
 if (_sid > 0) {
 ...
 void Adafruit_ST77xx_STM32::dummyclock(void) {
 ...
 uint8_t Adafruit_ST77xx_STM32::readdata(void) {
 ...
 *portOutputRegister(csport) |= cspin;
 ...
 uint8_t Adafruit_ST77xx_STM32::readcommand8(uint8_t c) {
 ...
 *portOutputRegister(csport) |= cspin;
 ...
 uint16_t Adafruit_ST77xx_STM32::readcommand16(uint8_t c) {
 digitalWrite(_rs, LOW);
 if (_cs)
 ...
 uint32_t Adafruit_ST77xx_STM32::readcommand32(uint8_t c) {
 digitalWrite(_rs, LOW);
 if (_cs)
 digitalWrite(_cs, LOW);
 spiwrite(c);
