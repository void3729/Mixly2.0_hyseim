...
class Adafruit_ST7735_STM32 : public Adafruit_ST77xx_STM32 {
public:
  Adafruit_ST7735_STM32(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst);
  Adafruit_ST7735_STM32(int8_t cs, int8_t dc, int8_t rst);
#if !defined(ESP8266)
  Adafruit_ST7735_STM32(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst);
#endif // end !ESP8266
