...
#ifndef __RF24_STM32_H__
#define __RF24_STM32_H__
...
public:
     ...
     */
    RF24_STM32(uint16_t _cepin, uint16_t _cspin, SPIClass *spi);
  ...
  */
    ...
    RF24_STM32(uint16_t _cepin, uint16_t _cspin, uint32_t spispeed);
    //#endif
