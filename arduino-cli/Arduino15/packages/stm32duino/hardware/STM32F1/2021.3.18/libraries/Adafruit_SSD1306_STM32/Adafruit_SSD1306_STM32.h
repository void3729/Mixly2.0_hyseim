...
#ifndef _Adafruit_SSD1306_STM32_H_
#define _Adafruit_SSD1306_STM32_H_

// ONE of the following three lines must be #defined:
//#define SSD1306_128_64 ///< DEPRECTAED: old way to specify 128x64 screen
#define SSD1306_128_32   ///< DEPRECATED: old way to specify 128x32 screen
//#define SSD1306_96_16  ///< DEPRECATED: old way to specify 96x16 screen
// This establishes the screen dimensions in old Adafruit_SSD1306_STM32 sketches
...
*/
class Adafruit_SSD1306_STM32 : public Adafruit_GFX_STM32 {
 public:
  // NEW CONSTRUCTORS -- recommended for new projects
  Adafruit_SSD1306_STM32(uint8_t w, uint8_t h, TwoWire *twi=&Wire, int8_t rst_pin=-1,
    uint32_t clkDuring=400000UL, uint32_t clkAfter=100000UL);
  Adafruit_SSD1306_STM32(uint8_t w, uint8_t h, int8_t mosi_pin, int8_t sclk_pin,
    int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
  Adafruit_SSD1306_STM32(uint8_t w, uint8_t h, SPIClass *spi,
    int8_t dc_pin, int8_t rst_pin, int8_t cs_pin, uint32_t bitrate=8000000UL);

  // DEPRECATED CONSTRUCTORS - for back compatibility, avoid in new projects
  Adafruit_SSD1306_STM32(int8_t mosi_pin, int8_t sclk_pin, int8_t dc_pin,
    int8_t rst_pin, int8_t cs_pin);
  Adafruit_SSD1306_STM32(int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
  Adafruit_SSD1306_STM32(int8_t rst_pin = -1);

  ~Adafruit_SSD1306_STM32(void);
...
#endif // _Adafruit_SSD1306_STM32_H_
