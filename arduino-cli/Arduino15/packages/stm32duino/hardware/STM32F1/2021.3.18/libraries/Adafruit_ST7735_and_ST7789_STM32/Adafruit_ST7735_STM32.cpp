#include "Adafruit_ST7735_STM32.h"
...
*/
Adafruit_ST7735_STM32::Adafruit_ST7735_STM32(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
    : Adafruit_ST77xx_STM32(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, mosi,
                      sclk, rst) {}
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7735_STM32::Adafruit_ST7735_STM32(int8_t cs, int8_t dc, int8_t rst)
    : Adafruit_ST77xx_STM32(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, rst) {}
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7735_STM32::Adafruit_ST7735_STM32(SPIClass *spiClass, int8_t cs, int8_t dc,
                                 int8_t rst)
    : Adafruit_ST77xx_STM32(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, spiClass, cs,
                      dc, rst) {}
#endif // end !ESP8266
...
*/
/**************************************************************************/
void Adafruit_ST7735_STM32::initB(void) {
  commonInit(Bcmd);
  setRotation(0);
}
...
*/
/**************************************************************************/
void Adafruit_ST7735_STM32::initR(uint8_t options) {
  commonInit(Rcmd1);
...
*/
/**************************************************************************/
void Adafruit_ST7735_STM32::setRotation(uint8_t m) {
  uint8_t madctl = 0;
