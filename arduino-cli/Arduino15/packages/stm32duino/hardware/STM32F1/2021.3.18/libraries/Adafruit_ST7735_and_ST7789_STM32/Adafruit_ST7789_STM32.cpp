#include "Adafruit_ST7789_STM32.h"
...
*/
Adafruit_ST7789_STM32::Adafruit_ST7789_STM32(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
    : Adafruit_ST77xx_STM32(240, 320, cs, dc, mosi, sclk, rst) {}
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789_STM32::Adafruit_ST7789_STM32(int8_t cs, int8_t dc, int8_t rst)
    : Adafruit_ST77xx_STM32(240, 320, cs, dc, rst) {}
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789_STM32::Adafruit_ST7789_STM32(SPIClass *spiClass, int8_t cs, int8_t dc,
                                 int8_t rst)
    : Adafruit_ST77xx_STM32(240, 320, spiClass, cs, dc, rst) {}
#endif // end !ESP8266
...
*/
/**************************************************************************/
void Adafruit_ST7789_STM32::init(uint16_t width, uint16_t height, uint8_t mode) {
  // Save SPI data mode. commonInit() calls begin() (in Adafruit_ST77xx_STM32.cpp),
...
*/
/**************************************************************************/
void Adafruit_ST7789_STM32::setRotation(uint8_t m) {
  uint8_t madctl = 0;
