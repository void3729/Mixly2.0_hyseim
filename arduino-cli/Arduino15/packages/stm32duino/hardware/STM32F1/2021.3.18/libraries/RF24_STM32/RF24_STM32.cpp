...
inline void RF24_STM32::beginTransaction()
{
...
inline void RF24_STM32::endTransaction()
{
    csn(HIGH);
    #if defined(RF24_spi_TRANSACTIONS)
    _spi->endTransaction();
...
uint8_t RF24_STM32::read_register(uint8_t reg, uint8_t* buf, uint8_t len)
{
    uint8_t status;
...
uint8_t RF24_STM32::read_register(uint8_t reg)
{
    uint8_t result;
...
uint8_t RF24_STM32::write_register(uint8_t reg, const uint8_t* buf, uint8_t len)
{
    uint8_t status;
...
uint8_t RF24_STM32::write_register(uint8_t reg, uint8_t value)
{
    uint8_t status;
...
uint8_t RF24_STM32::write_payload(const void* buf, uint8_t data_len, const uint8_t writeType)
{
    uint8_t status;
...
uint8_t RF24_STM32::read_payload(void* buf, uint8_t data_len)
{
    uint8_t status;
...
uint8_t RF24_STM32::flush_rx(void)
{
...
uint8_t RF24_STM32::flush_tx(void)
{
...
uint8_t RF24_STM32::spiTrans(uint8_t cmd)
{
...
uint8_t RF24_STM32::get_status(void)
{
...
void RF24_STM32::print_status(uint8_t status)
{
...
void RF24_STM32::print_observe_tx(uint8_t value)
{
...
void RF24_STM32::print_byte_register(const char* name, uint8_t reg, uint8_t qty)
{
...
void RF24_STM32::print_address_register(const char* name, uint8_t reg, uint8_t qty)
{
...
RF24_STM32::RF24_STM32(uint16_t _cepin, uint16_t _cspin,  SPIClass *spi)
...
RF24_STM32::RF24_STM32(uint16_t _cepin, uint16_t _cspin, uint32_t _spi_speed):
...
void RF24_STM32::setChannel(uint8_t channel)
{
    const uint8_t max_channel = 125;
    write_register(RF_CH, rf24_min(channel, max_channel));
}

uint8_t RF24_STM32::getChannel()
{
...
void RF24_STM32::setPayloadSize(uint8_t size)
{
...
uint8_t RF24_STM32::getPayloadSize(void)
{
    return payload_size;
}
...
void RF24_STM32::printDetails(void)
{
...
bool RF24_STM32::isChipConnected()
{
...
void RF24_STM32::startListening(void)
{
...
void RF24_STM32::stopListening(void)
{
    ce(LOW);
...
void RF24_STM32::powerDown(void)
{
...
bool RF24_STM32::write(const void* buf, uint8_t len, const bool multicast)
{
    //Start Writing
...
bool RF24_STM32::write(const void* buf, uint8_t len)
{
...
bool RF24_STM32::writeBlocking(const void* buf, uint8_t len, uint32_t timeout)
{
...
bool RF24_STM32::writeFast(const void* buf, uint8_t len, const bool multicast)
{
    //Block until the FIFO is NOT full.
    //Keep track of the MAX retries and set auto-retry if seeing failures
...
bool RF24_STM32::writeFast(const void* buf, uint8_t len)
{
...
void RF24_STM32::startFastWrite(const void* buf, uint8_t len, const bool multicast, bool startTx)
{ //TMRh20
...
void RF24_STM32::startWrite(const void* buf, uint8_t len, const bool multicast)
{
...
bool RF24_STM32::txStandBy(uint32_t timeout, bool startTx)
{
...
void RF24_STM32::maskIRQ(bool tx, bool fail, bool rx)
{
...
uint8_t RF24_STM32::getDynamicPayloadSize(void)
{
    uint8_t result = 0;
...
bool RF24_STM32::available(void)
{
...
bool RF24_STM32::available(uint8_t* pipe_num)
{
...
void RF24_STM32::read(void* buf, uint8_t len)
{
...
void RF24_STM32::whatHappened(bool& tx_ok, bool& tx_fail, bool& rx_ready)
{
...
void RF24_STM32::openWritingPipe(uint64_t value)
{
...
/****************************************************************************/
void RF24_STM32::openWritingPipe(const uint8_t* address)
{
    // Note that AVR 8-bit uC's store this LSB first, and the NRF24L01(+)
    // expects it LSB first too, so we're good.
...
void RF24_STM32::openReadingPipe(uint8_t child, uint64_t address)
{
...
/****************************************************************************/
void RF24_STM32::setAddressWidth(uint8_t a_width)
{
...
void RF24_STM32::openReadingPipe(uint8_t child, const uint8_t* address)
{
    // If this is pipe 0, cache the address.  This is needed because
    // openWritingPipe() will overwrite the pipe 0 address, so
    // startListening() will have to restore it.
...
void RF24_STM32::closeReadingPipe(uint8_t pipe)
{
...
void RF24_STM32::toggle_features(void)
{
    beginTransaction();
...
void RF24_STM32::enableDynamicPayloads(void)
{
...
/****************************************************************************/
void RF24_STM32::disableDynamicPayloads(void)
{
...
void RF24_STM32::enableAckPayload(void)
{
    //
...
void RF24_STM32::enableDynamicAck(void)
{
    //
...
void RF24_STM32::writeAckPayload(uint8_t pipe, const void* buf, uint8_t len)
{
    const uint8_t* current = reinterpret_cast<const uint8_t*>(buf);
...
bool RF24_STM32::isAckPayloadAvailable(void)
{
...
bool RF24_STM32::isPVariant(void)
{
    return p_variant;
}
...
void RF24_STM32::setAutoAck(bool enable)
{
    if (enable) {
...
void RF24_STM32::setAutoAck(uint8_t pipe, bool enable)
{
    if (pipe <= 6) {
...
bool RF24_STM32::testCarrier(void)
{
...
void RF24_STM32::setPALevel(uint8_t level)
{
...
uint8_t RF24_STM32::getPALevel(void)
{
...
uint8_t RF24_STM32::getARC(void)
{
...
bool RF24_STM32::setDataRate(rf24_datarate_e speed)
{
    bool result = false;
...
rf24_datarate_e RF24_STM32::getDataRate(void)
{
...
void RF24_STM32::setCRCLength(rf24_crclength_e length)
{
...
rf24_crclength_e RF24_STM32::getCRCLength(void)
{
...
void RF24_STM32::disableCRC(void)
{
...
/****************************************************************************/
void RF24_STM32::setRetries(uint8_t delay, uint8_t count)
{
