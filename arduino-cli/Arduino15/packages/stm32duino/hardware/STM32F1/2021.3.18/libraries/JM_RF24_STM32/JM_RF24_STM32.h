...
#ifndef __JM_RF24_STM32_H__
#define __JM_RF24_STM32_H__
...
public:
     ...
     */
    JM_RF24_STM32(uint16_t _cepin, uint16_t _cspin, SPIClass *spi);
  ...
  */
    ...
    JM_RF24_STM32(uint16_t _cepin, uint16_t _cspin, uint32_t spispeed);
    //#endif
