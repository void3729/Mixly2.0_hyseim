...
class Adafruit_GFX_STM32 : public Print {

 public:

  Adafruit_GFX_STM32(int16_t w, int16_t h); // Constructor
  ...
  // These exist only with Adafruit_GFX_STM32 (no subclass overrides)
  void
...
class Adafruit_GFX_STM32_Button {

 public:
  Adafruit_GFX_STM32_Button(void);
  // "Classic" initButton() uses center & size
  void initButton(Adafruit_GFX_STM32 *gfx, int16_t x, int16_t y,
  ...
  void initButtonUL(Adafruit_GFX_STM32 *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
   uint16_t textcolor, char *label, uint8_t textsize);
  void initButtonUL(Adafruit_GFX_STM32 *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
...
class GFXcanvas1 : public Adafruit_GFX_STM32 {
 public:
...
class GFXcanvas8 : public Adafruit_GFX_STM32 {
 public:
...
class GFXcanvas16 : public Adafruit_GFX_STM32 {
 public:
