...
#ifndef RL_YX5300_Serial_h
#define RL_YX5300_Serial_h
...
class YX5300_Serial: public SoftwareSerial
{

   public:

     YX5300_Serial(short rxPin, short txPin) : SoftwareSerial(rxPin,txPin) { };
...
class YX5300_Serial: public ESP32SoftwareSerial
{

   public:

     YX5300_Serial(short rxPin, short txPin) : ESP32SoftwareSerial(rxPin,txPin) { };
