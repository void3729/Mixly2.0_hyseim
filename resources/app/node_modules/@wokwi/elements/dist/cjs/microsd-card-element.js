...
let MicrosdCardElement = class MicrosdCardElement extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'DO', x: 76.734, y: 18.8622, signals: [pin_1.spi('MISO')] },
            { name: 'GND', x: 76.734, y: 28.4634, signals: [{ type: 'power', signal: 'GND' }] },
            { name: 'SCK', x: 76.734, y: 38.178, signals: [pin_1.spi('SCK')] },
            { name: 'VCC', x: 76.734, y: 47.628, signals: [{ type: 'power', signal: 'VCC' }] },
            { name: 'DI', x: 76.734, y: 57.456, signals: [pin_1.spi('MOSI')] },
            { name: 'CS', x: 76.734, y: 66.906, signals: [pin_1.spi('SS')] },
        ];
    }
    render() {
        return lit_1.html `
...
MicrosdCardElement = __decorate([
    decorators_js_1.customElement('wokwi-microsd-card')
], MicrosdCardElement);
