...
exports.StepperMotorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
let StepperMotorElement = class StepperMotorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.angle = 0;
        this.value = '';
...
StepperMotorElement = __decorate([
    decorators_js_1.customElement('wokwi-stepper-motor')
], StepperMotorElement);
exports.StepperMotorElement = StepperMotorElement;
