...
let TiltSwitchElement = class TiltSwitchElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 18, x: 88, number: 1, signals: [pin_1.GND()] },
            { name: 'VCC', y: 27.8, x: 88, number: 2, signals: [pin_1.VCC()] },
...
TiltSwitchElement = __decorate([
    decorators_js_1.customElement('wokwi-tilt-switch')
], TiltSwitchElement);
