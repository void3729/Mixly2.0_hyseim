...
exports.IRRemoteElement = void 0;
...
let IRRemoteElement = class IRRemoteElement extends lit_1.LitElement {
    static get styles() {
        return lit_1.css `
      use {
        fill: #fff;
    ...
    keyboardEvent(event, type) {
        var _a;
        if (keys_1.SPACE_KEYS.includes(event.key)) {
...
IRRemoteElement = __decorate([
    decorators_js_1.customElement('wokwi-ir-remote')
], IRRemoteElement);
exports.IRRemoteElement = IRRemoteElement;
