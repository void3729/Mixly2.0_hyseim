...
let IRReceiverElement = class IRReceiverElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 87.75, x: 20.977, number: 1, signals: [pin_1.GND()] },
            { name: 'VCC', y: 87.75, x: 30.578, number: 2, signals: [pin_1.VCC()] },
...
IRReceiverElement = __decorate([
    decorators_js_1.customElement('wokwi-ir-receiver')
], IRReceiverElement);
