...
let HeartBeatSensorElement = class HeartBeatSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 17.8, x: 87, number: 1, signals: [pin_1.GND()] },
            { name: 'VCC', y: 27.5, x: 87, number: 2, signals: [pin_1.VCC()] },
...
HeartBeatSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-heart-beat-sensor')
