...
let PhotoresistorSensorElement = class PhotoresistorSensorElement extends lit_1.LitElement {
    constructor() {
        ...
        this.ledPower = false;
        this.pinInfo = [
            { name: 'VCC', x: 172, y: 16, signals: [pin_1.VCC()] },
            { name: 'GND', x: 172, y: 26, signals: [pin_1.GND()] },
            { name: 'DO', x: 172, y: 35.8, signals: [] },
            { name: 'AO', x: 172, y: 45.5, signals: [pin_1.analog(0)] },
        ];
    }
    render() {
      ...
      >
        ...
        ${ledPower && lit_1.svg `<circle cx="124.5" cy="7" r="4" fill="green" filter="url(#ledFilter)" />`}

        <rect x="118" y="52.6" width="13" height="4.29" fill="#dae3eb" />
        <rect x="121" y="52.5" width="6.55" height="4.59" fill="#fffefe" />
        ${ledDO && lit_1.svg `<circle cx="124.5" cy="55" r="4" fill="red" filter="url(#ledFilter)" />`}
...
PhotoresistorSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-photoresistor-sensor')
