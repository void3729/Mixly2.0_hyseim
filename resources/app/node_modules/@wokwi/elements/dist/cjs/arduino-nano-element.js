...
exports.ArduinoNanoElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
const keys_1 = require("./utils/keys");
let ArduinoNanoElement = class ArduinoNanoElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.led13 = false;
        this.ledRX = false;
        ...
        this.pinInfo = [
            { name: '12', x: 19.7, y: 4.8, signals: [pin_1.spi('MISO')] },
            { name: '11', x: 29.3, y: 4.8, signals: [pin_1.spi('MOSI'), { type: 'pwm' }] },
            { name: '10', x: 38.9, y: 4.8, signals: [pin_1.spi('SS'), { type: 'pwm' }] },
            ...
            { name: '1', x: 144.5, y: 4.8, signals: [pin_1.usart('TX')] },
            { name: '0', x: 154.1, y: 4.8, signals: [pin_1.usart('RX')] },
            { name: '13', x: 19.7, y: 62.4, signals: [pin_1.spi('SCK')] },
            { name: '3.3V', x: 29.3, y: 62.4, signals: [{ type: 'power', signal: 'VCC', voltage: 3.3 }] },
            { name: 'AREF', x: 38.9, y: 62.4, signals: [] },
            { name: 'A0', x: 48.5, y: 62.4, signals: [pin_1.analog(0)] },
            { name: 'A1', x: 58.1, y: 62.4, signals: [pin_1.analog(1)] },
            { name: 'A2', x: 67.7, y: 62.4, signals: [pin_1.analog(2)] },
            { name: 'A3', x: 77.3, y: 62.4, signals: [pin_1.analog(3)] },
            { name: 'A4', x: 86.9, y: 62.4, signals: [pin_1.analog(4), pin_1.i2c('SDA')] },
            { name: 'A5', x: 96.5, y: 62.4, signals: [pin_1.analog(5), pin_1.i2c('SCL')] },
            { name: 'A6', x: 106.1, y: 62.4, signals: [pin_1.analog(6)] },
            { name: 'A7', x: 115.7, y: 62.4, signals: [pin_1.analog(7)] },
            ...
            { name: '12.2', x: 163.7, y: 43.2, signals: [pin_1.spi('MISO')] },
            { name: '5V.2', x: 154.1, y: 43.2, signals: [{ type: 'power', signal: 'VCC', voltage: 5 }] },
            { name: '13.2', x: 163.7, y: 33.6, signals: [pin_1.spi('SCK')] },
            { name: '11.2', x: 154.1, y: 33.6, signals: [pin_1.spi('MOSI'), { type: 'pwm' }] },
    ...
    render() {
      ...
      >
        ...
        <g transform="translate(27.7 5)">
          ...
          ${ledTX &&
            lit_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#ff8080" filter="url(#ledFilter)" />`}
        </g>
        <g transform="translate(27.7 7)">
          <use xlink:href="#led-body" />
          ${ledRX &&
            lit_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#80ff80" filter="url(#ledFilter)" />`}
        </g>
        ...
        <g transform="translate(27.7 11)">
          <use xlink:href="#led-body" />
          ${led13 &&
            lit_1.svg `<circle cx="1.3" cy=".55" r="1.3" fill="#ffff80" filter="url(#ledFilter)" />`}
        </g>
...
__decorate([
    decorators_js_1.query('#reset-button')
], ArduinoNanoElement.prototype, "resetButton", void 0);
ArduinoNanoElement = __decorate([
    decorators_js_1.customElement('wokwi-arduino-nano')
], ArduinoNanoElement);
exports.ArduinoNanoElement = ArduinoNanoElement;
