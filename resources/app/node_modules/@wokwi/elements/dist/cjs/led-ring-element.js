...
exports.LEDRingElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const units_1 = require("./utils/units");
const pinHeight = 3;
const pcbWidth = 6;
let LEDRingElement = class LEDRingElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        /**
    ...
    get pinInfo() {
        ...
        const y = (radius * 2 + pinHeight) * units_1.mmToPix;
        const cx = radius * units_1.mmToPix;
    ...
    render() {
        ...
        for (let i = 0; i < pixels; i++) {
            ...
            pixelElements.push(lit_1.svg `<rect
          class="pixel"
          x="${radius - 2.5}"
          y="${pcbWidth / 2 - 2.5}"
          width="5"
...
LEDRingElement = __decorate([
    decorators_js_1.customElement('wokwi-led-ring')
], LEDRingElement);
exports.LEDRingElement = LEDRingElement;
