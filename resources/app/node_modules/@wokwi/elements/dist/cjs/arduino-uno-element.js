...
let ArduinoUnoElement = class ArduinoUnoElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.led13 = false;
        this.ledRX = false;
        ...
        this.ledPower = false;
        this.pinInfo = [
            { name: 'A5.2', x: 87, y: 9, signals: [pin_1.analog(5), pin_1.i2c('SCL')] },
            { name: 'A4.2', x: 97, y: 9, signals: [pin_1.analog(4), pin_1.i2c('SDA')] },
            { name: 'AREF', x: 106, y: 9, signals: [] },
            { name: 'GND.1', x: 115.5, y: 9, signals: [{ type: 'power', signal: 'GND' }] },
            { name: '13', x: 125, y: 9, signals: [pin_1.spi('SCK')] },
            { name: '12', x: 134.5, y: 9, signals: [pin_1.spi('MISO')] },
            { name: '11', x: 144, y: 9, signals: [pin_1.spi('MOSI'), { type: 'pwm' }] },
            { name: '10', x: 153.5, y: 9, signals: [pin_1.spi('SS'), { type: 'pwm' }] },
            ...
            { name: '1', x: 246, y: 9, signals: [pin_1.usart('TX')] },
            { name: '0', x: 255.5, y: 9, signals: [pin_1.usart('RX')] },
            ...
            { name: 'A0', x: 208, y: 191.5, signals: [pin_1.analog(0)] },
            { name: 'A1', x: 217.5, y: 191.5, signals: [pin_1.analog(1)] },
            { name: 'A2', x: 227, y: 191.5, signals: [pin_1.analog(2)] },
            { name: 'A3', x: 236.5, y: 191.5, signals: [pin_1.analog(3)] },
            { name: 'A4', x: 246, y: 191.5, signals: [pin_1.analog(4), pin_1.i2c('SDA')] },
            { name: 'A5', x: 255.5, y: 191.5, signals: [pin_1.analog(5), pin_1.i2c('SCL')] },
        ];
    }
    static get styles() {
        return lit_1.css `
...
ArduinoUnoElement = __decorate([
    decorators_js_1.customElement('wokwi-arduino-uno')
], ArduinoUnoElement);
