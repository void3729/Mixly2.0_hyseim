...
exports.ArduinoMegaElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pins_female_1 = require("./patterns/pins-female");
const pin_1 = require("./pin");
let ArduinoMegaElement = class ArduinoMegaElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.led13 = false;
        this.ledRX = false;
        ...
        this.ledPower = false;
        this.pinInfo = [
            { name: 'SCL', x: 90, y: 9, signals: [pin_1.i2c('SCL')] },
            { name: 'SDA', x: 100, y: 9, signals: [pin_1.i2c('SDA')] },
            ...
            { name: '1', x: 247.5, y: 9, signals: [pin_1.usart('TX')] },
            { name: '0', x: 257.5, y: 9, signals: [pin_1.usart('RX')] },
            { name: '14', x: 270.5, y: 9, signals: [pin_1.usart('TX', 3)] },
            { name: '15', x: 280, y: 9, signals: [pin_1.usart('RX', 3)] },
            { name: '16', x: 289.5, y: 9, signals: [pin_1.usart('TX', 2)] },
            { name: '17', x: 299, y: 9, signals: [pin_1.usart('RX', 2)] },
            { name: '18', x: 308.5, y: 9, signals: [pin_1.usart('TX', 1)] },
            { name: '19', x: 318.5, y: 9, signals: [pin_1.usart('RX', 1)] },
            { name: '20', x: 328, y: 9, signals: [pin_1.i2c('SDA')] },
            { name: '21', x: 337.5, y: 9, signals: [pin_1.i2c('SCL')] },
            ...
            { name: '50', x: 361, y: 152, signals: [pin_1.spi('MISO')] },
            { name: '51', x: 371, y: 152, signals: [pin_1.spi('MOSI')] },
            { name: '52', x: 361, y: 161.5, signals: [pin_1.spi('SCK')] },
            { name: '53', x: 371, y: 161.5, signals: [pin_1.spi('SS')] },
            ...
            { name: 'A0', x: 208.5, y: 184.5, signals: [pin_1.analog(0)] },
            { name: 'A1', x: 218, y: 184.5, signals: [pin_1.analog(1)] },
            { name: 'A2', x: 227.5, y: 184.5, signals: [pin_1.analog(2)] },
            { name: 'A3', x: 237.25, y: 184.5, signals: [pin_1.analog(3)] },
            { name: 'A4', x: 246.75, y: 184.5, signals: [pin_1.analog(4)] },
            { name: 'A5', x: 256.25, y: 184.5, signals: [pin_1.analog(5)] },
            { name: 'A6', x: 266, y: 184.5, signals: [pin_1.analog(6)] },
            { name: 'A7', x: 275.5, y: 184.5, signals: [pin_1.analog(7)] },
            { name: 'A8', x: 290.25, y: 184.5, signals: [pin_1.analog(8)] },
            { name: 'A9', x: 300, y: 184.5, signals: [pin_1.analog(9)] },
            { name: 'A10', x: 309.5, y: 184.5, signals: [pin_1.analog(10)] },
            { name: 'A11', x: 319.25, y: 184.5, signals: [pin_1.analog(11)] },
            { name: 'A12', x: 328.75, y: 184.5, signals: [pin_1.analog(12)] },
            { name: 'A13', x: 338.5, y: 184.5, signals: [pin_1.analog(13)] },
            { name: 'A14', x: 348, y: 184.5, signals: [pin_1.analog(14)] },
            { name: 'A15', x: 357.75, y: 184.5, signals: [pin_1.analog(15)] },
        ];
    }
    static get styles() {
        return lit_1.css `
    ...
    render() {
      ...
      >
        ...
        <g transform="translate(72.20 15.58)">
          ...
          ${ledPower &&
            lit_1.svg `<circle cx="1.3" cy="0.55" r="1.3" fill="#80ff80" filter="url(#ledFilter)" />`}
        </g>
        ...
        <g transform="translate(26 13.86)">
          <use xlink:href="#led-body" />
          ${led13 &&
            lit_1.svg `<circle cx="1.3" cy="0.55" r="1.3" fill="#ff8080" filter="url(#ledFilter)" />`}
        </g>

        <g transform="translate(26 18.52)">
          <use xlink:href="#led-body" />
          ${ledTX &&
            lit_1.svg `<circle cx="0.975" cy="0.55" r="1.3" fill="yellow" filter="url(#ledFilter)" />`}
        </g>
...
ArduinoMegaElement = __decorate([
    decorators_js_1.customElement('wokwi-arduino-mega')
], ArduinoMegaElement);
exports.ArduinoMegaElement = ArduinoMegaElement;
