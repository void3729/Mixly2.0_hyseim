...
let SSD1306Element = class SSD1306Element extends lit_1.LitElement {
    constructor() {
        ...
        this.ctx = null;
        this.pinInfo = [
            { name: 'DATA', x: 36.5, y: 12.5, signals: [pin_1.i2c('SDA')] },
            { name: 'CLK', x: 45.5, y: 12.5, signals: [pin_1.i2c('SCL')] },
    ...
    render() {
        ...
        return lit_1.html ` <div class="container">
...
SSD1306Element = __decorate([
    decorators_js_1.customElement('wokwi-ssd1306')
], SSD1306Element);
