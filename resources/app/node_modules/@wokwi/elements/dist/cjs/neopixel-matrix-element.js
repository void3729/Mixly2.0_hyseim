 ...
 * pixel to red.
 */
let NeopixelMatrixElement = class NeopixelMatrixElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        /**
    ...
    get pinInfo() {
        ...
        const p = pinSpacing * units_1.mmToPix;
        const cx = ((cols * (colSpacing + pixelWidth)) / 2) * units_1.mmToPix;
        const y = rows * (rowSpacing + pixelHeight) * units_1.mmToPix;
        return [
            {
                name: 'GND',
                x: cx - 1.5 * p,
            ...
            { name: 'VCC', x: cx - 0.5 * p, y, signals: [pin_1.VCC()] },
...
__decorate([
    decorators_js_1.property({ attribute: 'rowspacing' })
], NeopixelMatrixElement.prototype, "rowSpacing", void 0);
__decorate([
    decorators_js_1.property({ attribute: 'colspacing' })
...
NeopixelMatrixElement = __decorate([
    decorators_js_1.customElement('wokwi-neopixel-matrix')
