...
let MPU6050Element = class MPU6050Element extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'SDA', x: 45.6, y: 5.78, signals: [pin_1.i2c('SDA')] },
            { name: 'SCL', x: 55.2, y: 5.78, signals: [pin_1.i2c('SCL')] },
            { name: 'GND', x: 64.8, y: 5.78, signals: [pin_1.GND()] },
            { name: 'VCC', x: 74.4, y: 5.78, signals: [pin_1.VCC()] },
        ];
    }
    render() {
        const { led1 } = this;
      ...
      >
        ...
        ${led1 &&
            lit_1.svg `<circle cx="13.9" cy="25.5" r="3.5" fill="#80ff80" filter="url(#ledFilter)" />`}
...
MPU6050Element = __decorate([
    decorators_js_1.customElement('wokwi-mpu6050')
], MPU6050Element);
