...
let NTCTemperatureSensorElement = class NTCTemperatureSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 26.2, x: 135, number: 1, signals: [pin_1.GND()] },
            { name: 'VCC', y: 35.8, x: 135, number: 2, signals: [pin_1.VCC()] },
            { name: 'OUT', y: 45.5, x: 135, number: 3, signals: [pin_1.analog(0)] },
        ];
    }
    render() {
        return lit_1.html `
...
NTCTemperatureSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-ntc-temperature-sensor')
