...
let Ds1307Element = class Ds1307Element extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 15, x: 9.5, number: 1, signals: [pin_1.GND()] },
            { name: '5V', y: 25, x: 9.5, number: 2, signals: [pin_1.VCC(5)] },
            { name: 'SDA', y: 34.5, x: 9.5, number: 3, signals: [pin_1.i2c('SDA')] },
            { name: 'SCL', y: 44, x: 9.5, number: 4, signals: [pin_1.i2c('SCL')] },
...
Ds1307Element = __decorate([
    decorators_js_1.customElement('wokwi-ds1307')
], Ds1307Element);
