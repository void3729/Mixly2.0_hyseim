...
exports.GasSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let GasSensorElement = class GasSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'AOUT', y: 16.5, x: 137, number: 1, signals: [] },
            { name: 'DOUT', y: 26.4, x: 137, number: 2, signals: [] },
            { name: 'GND', y: 36.5, x: 137, number: 3, signals: [pin_1.GND()] },
            { name: 'VCC', y: 46.2, x: 137, number: 4, signals: [pin_1.VCC()] },
        ];
    }
    render() {
        return lit_1.html `
...
GasSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-gas-sensor')
], GasSensorElement);
exports.GasSensorElement = GasSensorElement;
