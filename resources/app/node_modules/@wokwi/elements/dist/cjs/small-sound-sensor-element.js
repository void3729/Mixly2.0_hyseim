...
exports.SmallSoundSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let SmallSoundSensorElement = class SmallSoundSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledPower = false;
        ...
        this.pinInfo = [
            ...
            { name: 'GND', y: 20.5, x: 0, number: 2, signals: [pin_1.GND()] },
            { name: 'VCC', y: 30.5, x: 0, number: 3, signals: [pin_1.VCC()] },
    ...
    render() {
      ...
      >
        ...
        ${ledPower && lit_1.svg `<circle cx="56" cy="4" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
        ...
        ${ledSignal &&
            lit_1.svg `<circle cx="56" cy="47" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
...
SmallSoundSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-small-sound-sensor')
], SmallSoundSensorElement);
exports.SmallSoundSensorElement = SmallSoundSensorElement;
