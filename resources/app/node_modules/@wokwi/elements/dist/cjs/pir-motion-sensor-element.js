...
let PIRMotionSensorElement = class PIRMotionSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'VCC', y: 92, x: 36.178, number: 1, signals: [pin_1.VCC()] },
            { name: 'OUT', y: 92, x: 45.9175, number: 2, signals: [] },
            { name: 'GND', y: 92, x: 55.6415, number: 3, signals: [pin_1.GND()] },
        ];
    }
    render() {
        return lit_1.html `
...
PIRMotionSensorElement = __decorate([
    decorators_js_1.customElement('wokwi-pir-motion-sensor')
