...
let ILI9341Element = class ILI9341Element extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'CS', x: 67.5024, y: 287.2, signals: [pin_1.spi('SS')] },
            { name: 'RST', x: 77.1036, y: 287.2, signals: [] },
            { name: 'D/C', x: 86.7048, y: 287.2, signals: [] },
            { name: 'MOSI', x: 96.306, y: 287.2, signals: [pin_1.spi('MOSI')] },
            { name: 'SCK', x: 105.9072, y: 287.2, signals: [pin_1.spi('SCK')] },
            { name: 'LED', x: 115.5084, y: 287.2, signals: [] },
            { name: 'MISO', x: 125.1096, y: 287.2, signals: [pin_1.spi('MISO')] },
        ];
    }
    static get styles() {
        return lit_1.css `
...
ILI9341Element = __decorate([
    decorators_js_1.customElement('wokwi-ili9341')
], ILI9341Element);
