...
let SlidePotentiometerElement = class SlidePotentiometerElement extends lit_1.LitElement {
    ...
    get pinInfo() {
        return [
            ...
            { name: 'SIG', x: 1, y: 66.5, number: 2, signals: [pin_1.analog(0)] },
            {
                name: 'GND',
    ...
    updateValue(value) {
        this.value = clamp_1.clamp(this.min, this.max, value);
...
SlidePotentiometerElement = __decorate([
    decorators_js_1.customElement('wokwi-slide-potentiometer')
