...
let LedBarGraphElement = class LedBarGraphElement extends LitElement {
    ...
    render() {
      ...
      >
        ...
        ${segments.map((index) => {
            var _a;
            return svg `<rect x="2.5" y="${0.4 + index * 2.54}" width="5" height="1.74" fill="${values[index] ? (_a = palette === null || palette === void 0 ? void 0 : palette[index]) !== null && _a !== void 0 ? _a : color : offColor}"/>`;
        })}
      </svg>
    `;
    }
