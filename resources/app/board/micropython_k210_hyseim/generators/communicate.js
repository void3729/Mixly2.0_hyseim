...
Blockly.Python.communicate_i2c_init = function () {
	...
	var sda = Blockly.Python.valueToCode(this, 'RX',Blockly.Python.ORDER_ATOMIC);
	var scl = Blockly.Python.valueToCode(this, 'TX',Blockly.Python.ORDER_ATOMIC);
    return ""+sub+" = I2C(I2C.I2C1, freq="+freq+", scl="+scl+", sda="+sda+")\n";
};
