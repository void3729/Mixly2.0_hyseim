...
Blockly.Blocks['serial_softserial1'] = {
  init: function() {
   this.setColour(Blockly.Blocks.serial.HUE);
...
Blockly.Blocks['serial_send_to_mixgoce'] = {
   init: function() {
    this.setColour(Blockly.Blocks.serial.HUE);
    ...
    this.appendDummyInput()
        .appendField(Blockly.LANG_CONTROLS_FOR_INPUT_TO+'MixGo CE')
        .appendField(Blockly.LANG_CONTROLS_WHILEUNTIL_TITLE_REPEAT)
        .appendField(new Blockly.FieldDropdown([[Blockly.MIXLY_TURTLE_WRITE_MOVE_TRUE, '1'], [Blockly.MIXLY_TURTLE_WRITE_MOVE_FALSE, '0']]), 'STAT')
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
};
...
Blockly.Blocks['serial_read_from_mixgoce'] = {
  init: function() {
    this.setColour(Blockly.Blocks.serial.HUE);
    this.appendDummyInput()
        .appendField("Serial")
        .appendField(new Blockly.FieldDropdown([['uart1', '1'], ['uart2', '2'], ['uart3', '3']]), 'mode')
        .appendField(Blockly.MIXLY_ESP32_READ+'MixGo CE'+Blockly.MIXLY_SD_DATA);
    this.setOutput(true, Boolean);
  }
};