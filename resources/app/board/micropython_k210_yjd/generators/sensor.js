...
Blockly.Python.sensor_mpu9250_get_gyro = function(){
    Blockly.Python.definitions_['import gyro'] = 'import gyro';
    var key = this.getFieldValue('key');
    var v = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC); 
    var code = v+'.getRawLvgl' + key + '()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Python.sensor_dht11 = function () {
    Blockly.Python.definitions_['import dht11'] = 'import dht11_k210';
    var TYPE = this.getFieldValue('TYPE');
    var PIN = Blockly.Python.valueToCode(this, 'PIN', Blockly.Python.ORDER_ATOMIC);
	if(TYPE=="2")
		var code ='dht11_k210.read_data('+PIN+')';
	else
		var code ='dht11_k210.read_data('+PIN+')['+TYPE+']';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Python.sensor_20607_init = function(){
    var v = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import gyro'] = 'import gyro';
    var code = v + '.init()\n';
    return code;
