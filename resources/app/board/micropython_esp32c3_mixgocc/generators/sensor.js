...
Blockly.Python.sensor_mixgo_pin_near = function(){
    Blockly.Python.definitions_['import_ltr553als_onboard_ltr553als'] = "from ltr553als import onboard_ltr553als";
...
Blockly.Python.sensor_hp203=function(){
    var sub = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC);
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_hp203x_onboard_hp203x'] = "from hp203x import onboard_hp203x";
...
Blockly.Python.sensor_aht11=function(){
    var sub = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC);
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_ahtx0_onboard_ahtx0'] = "from ahtx0 import onboard_ahtx0";
...
Blockly.Python.rfid_readcontent=function(){    
    ...
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_rc522_onboard_rc522'] = "from rc522 import onboard_rc522";
    var code =  'onboard_rc522.read_card('+sector+')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Python.sensor_get_acceleration = function(){
    Blockly.Python.definitions_['import_mxc6655xa_onboard_mxc6655xa'] = "from mxc6655xa import onboard_mxc6655xa";
    var key = this.getFieldValue('key');
    var code;
    if (key=='x') {
        code = 'onboard_mxc6655xa.getdata()[0]';
    }else if (key=='y') {
        code = 'onboard_mxc6655xa.getdata()[1]';
    }else if (key=='z') {
        code = 'onboard_mxc6655xa.getdata()[2]';
    }else if (key=='values') {
        code = 'onboard_mxc6655xa.getdata()[0:3]';
    }
    return [code, Blockly.Python.ORDER_ATOMIC];
};
