...
class MIDI():
    ...
    def play(self, tune, pin=10, duration=None):
    ...
    # def play_show(self, tune, pin=10, display=matrix.display, duration=None):
    #     from machine import Pin, PWM
    #     from utime import sleep_ms
    #     pwm = PWM(Pin(pin))
    #     if duration is None:
    ...
    def play_show(self, tune, pin=10, duration=None):
        from machine import Pin, PWM
        from utime import sleep_ms
        pwm = PWM(Pin(pin))
        if duration is None:
