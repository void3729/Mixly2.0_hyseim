...
Blockly.Blocks['sensor_mixgoce_pin_near_line'] = {
    init: function(){
        this.setColour(Blockly.Blocks.sensor.HUE);
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldDropdown([
                ...
                [Blockly.MIXGO_LEFT_MID, "2"],
                [Blockly.MIXGO_RIGHT_MID, "3"],
                [Blockly.Msg.TEXT_TRIM_RIGHT, "4"]
                ]), "key")
            .appendField(Blockly.MIXGO_LINE_SENSOR);
        this.setOutput(true,Number);
        this.setInputsInline(true);
        var thisBlock = this;
...
Blockly.Blocks['sensor_mixgoce_pin_near'] = {
    init: function(){
        ...
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_MICROBIT_PY_STORAGE_GET)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.MIXGO_LEFT_FRONT, "Q1"], 
                [Blockly.MIXGO_RIGHT_FRONT, "Q2"],
                [Blockly.MIXGO_LEFT_BACK, "H1"],
                [Blockly.MIXGO_RIGHT_BACK, "H2"]
                ]), "key")
