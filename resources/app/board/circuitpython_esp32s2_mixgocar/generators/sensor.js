...
Blockly.Python.RTC_set_datetime= function () {
    Blockly.Python.definitions_['import_mixgocar_rtc_clock'] = 'from mixgocar import rtc_clock';
    ...
    Blockly.Python.setups_["RTC_set_datetime"] ='def RTC_set_datetime(year, month, day, hour, minute, second, weekday, yearday, isdist):\n' +
                                                '    rtc_clock.datetime = time.struct_time((year, month, day, hour, minute, second, weekday, yearday, isdist))\n';
