...
Blockly.Python.communicate_i2c_onboard = function(){
    ...
    var code = 'mixgocar.i2c';
    return [code, Blockly.Python.ORDER_ATOMIC];
};

Blockly.Python.communicate_irremote_receive = function(){
    var c = this.getFieldValue('op');
    Blockly.Python.definitions_['import_mixgocar_'+c] = 'from mixgocar import '+c;
    var code = c+'()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
...
Blockly.Python.communicate_spi_init= function(block) {
    ...
    return ""+name+" = busio.SPI(clock=board." + sck + ", MOSI=board." + mosi + ", MISO=board." + miso + ")\n";
};
