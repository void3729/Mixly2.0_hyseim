...
Blockly.Arduino.I2Cmotor = function() {
   ...
   Blockly.Arduino.definitions_['include_Adafruit_PWMServoDriver'] =  '#include <Adafruit_PWMServoDriver.h>';
   Blockly.Arduino.definitions_['var_declare_Adafruit_PWMServoDriver'] =  'Adafruit_PWMServoDriver pwm = Adafruit_PWMServoDriver();';
...
Blockly.Arduino.M9101X_S_MP3_CONTROL = function () {
  ...
  Blockly.Arduino.definitions_['var_declare_N910X_ mp3'+dropdown_pin] ='N910X mp3_'+dropdown_pin+'('+dropdown_pin+');';
