...
Blockly.Blocks['esp32_pin'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/ESP32.jpg", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['handbit_A'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/handbit_A.jpg", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['handbit_B'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/handbit_B.jpg", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['handbit_pin_A'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/handbit_pin_A.jpg", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['handbit_pin_B'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/handbit_pin_B.jpg", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['mixgo_pin_A'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/MixGo_pin_A.png", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['mixgo_pin_B'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/MixGo_pin_B.png", 525, 376, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['PocketCard_A'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/PocketCard_A.JPG", 525, 321, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['PocketCard_B'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/PocketCard_B.JPG", 525, 339, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
...
Blockly.Blocks['PocketCard_pin'] = {
  init: function() {
    this.appendDummyInput()
    .appendField(new Blockly.FieldImage("../common/media/board_pin/PocketCard_pin.png", 525, 440, "*"));
    this.setColour(Blockly.Blocks.tools.HUE);
    this.setTooltip();
    this.setHelpUrl();
  }
