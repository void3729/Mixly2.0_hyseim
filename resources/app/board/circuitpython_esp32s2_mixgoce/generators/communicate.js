...
Blockly.Python.communicate_irremote_receive = function(){
    var c = this.getFieldValue('op');
    Blockly.Python.definitions_['import_irremote_' + c] = 'from irremote import ' + c;
    var code = c + '()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};

Blockly.Python.communicate_irremote_send = function(){
    var c = this.getFieldValue('op');
    Blockly.Python.definitions_['import_irremote_'+c] = 'from irremote import '+c;
...
Blockly.Python.communicate_wireless_socket_init = function () {
    Blockly.Python.definitions_['import_board'] = 'import board';
    Blockly.Python.definitions_['import_wiresocket'] = 'import wiresocket';
    var dropdown_pin1 = Blockly.Python.valueToCode(this, 'ON',Blockly.Python.ORDER_ATOMIC);
    var dropdown_pin2 = Blockly.Python.valueToCode(this, 'OFF',Blockly.Python.ORDER_ATOMIC);
    var sub = Blockly.Python.valueToCode(this, 'SUB',Blockly.Python.ORDER_ATOMIC);
    return sub+" = wiresocket.Wireless_Socket(board."+dropdown_pin2+", board."+dropdown_pin1+")\n";
};

Blockly.Python.communicate_wireless_socket_on_off = function(){
    Blockly.Python.definitions_['import_wiresocket'] = 'import wiresocket';
