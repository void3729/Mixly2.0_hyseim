...
Blockly.Python.storage_sd_card_init=function(){
    ...
    Blockly.Python.definitions_['import_adafruit_sdcard'] = 'import adafruit_sdcard';
    var code = v + ' = adafruit_sdcard.SDCard('+ sv + ', '+ pv + ')\n';
    return code;
};

Blockly.Python.storage_sd_card_mount=function(){
    var v = Blockly.Python.valueToCode(this, 'SUB', Blockly.Python.ORDER_ATOMIC);
    var p = Blockly.Python.valueToCode(this, 'PATH', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import_storage'] = 'import storage';
    var code = 'storage.mount(storage.VfsFat('+ v + '), '+ p + ')\n';
    return code;
};