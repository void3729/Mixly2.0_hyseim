...
pbc.moduleFunctionD.get('mixgoce.display')['show_dynamic'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1 && args.length !== 2) {
        throw new Error("Incorrect number of arguments");
    }
    if (args.length == 2) {
        var data = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['scroll'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1 && args.length !== 2) {
        throw new Error("Incorrect number of arguments");
    }
    if (args.length == 2) {
...
pbc.moduleFunctionD.get('mixgoce.display')['show_static'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var data = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['up'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var data = py2block.convert(args[0]);
    return [block("display_shift", func.lineno, {
        "OP": "up"
    }, {
        "val": data
    }, {
...
pbc.moduleFunctionD.get('mixgoce.display')['down'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var data = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['left'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var data = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['right'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var data = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['get_pixel'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 2) {
        throw new Error("Incorrect number of arguments");
    }
    var x_data = {
    ...
    var x = py2block.convert(x_data);
    var y = py2block.convert(y_data);
...
pbc.moduleFunctionD.get('mixgoce.display')['set_pixel'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 3) {
        throw new Error("Incorrect number of arguments");
    }
    var x_data = {
    ...
    var x = py2block.convert(x_data);
    var y = py2block.convert(y_data);
    var stat = py2block.convert(args[2]);
...
pbc.moduleFunctionD.get('mixgoce.display')['set_brightness'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var brightness = py2block.convert(args[0]);
...
pbc.moduleFunctionD.get('mixgoce.display')['get_brightness'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 0) {
        throw new Error("Incorrect number of arguments");
    }
...
pbc.moduleFunctionD.get('mixgoce.display')['clear'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 0) {
        throw new Error("Incorrect number of arguments");
    }
...
pbc.assignD.get('TM1650')['check_assign'] = function (py2block, node, targets, value) {
    if(value.func._astname != "Attribute" || value.func.value._astname != "Name"){
        return false;
    }
    var moduleName = py2block.Name_str(value.func.value);
    var funcName = py2block.identifier(value.func.attr);
    if (value._astname === "Call" && moduleName === "tm1650"
        && funcName === "TM1650" && value.args.length === 1)
        return true;
    return false;
}

pbc.assignD.get('TM1650')['create_block'] = function (py2block, node, targets, value) {
    var sub = py2block.convert(node.targets[0]);
    var i2csub = py2block.convert(value.args[0]);
...
pbc.objectFunctionD.get('on')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 0) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
...
pbc.objectFunctionD.get('off')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 0) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
...
pbc.objectFunctionD.get('clear')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 0) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
...
pbc.objectFunctionD.get('shownum')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
...
pbc.objectFunctionD.get('showDP')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 2) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
...
pbc.objectFunctionD.get('intensity')['tm1650'] = function (py2block, func, args, keywords, starargs, kwargs, node) {
    if (args.length !== 1) {
        throw new Error("Incorrect number of arguments");
    }
    var objblock = py2block.convert(func.value);
    var args0 = py2block.convert(args[0]);
    return [block("display_tm1650_set_brightness", func.lineno, {}, {
        "VAR": objblock,
        "VALUE": args0
    }, {
        "inline": "true"
