...
Blockly.Blocks['storage_file_status'] = {
 ...
 Blockly.Blocks.storage_sd_card_init = {
    init: function () {
        this.setColour(Blockly.Blocks.storage.HUE);
        ...
        this.appendValueInput('SUB')
            .appendField(Blockly.MIXLY_MICROPYTHON_SOCKET_MAKE + Blockly.MIXLY_SD_CARD)
            .setCheck("var");
        this.appendDummyInput("")
 ...
 Blockly.Blocks.storage_sd_card_mount = {
    init: function () {
        this.setColour(Blockly.Blocks.storage.HUE);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.LISTS_SET_INDEX_INPUT_TO + Blockly.MIXLY_SD_CARD)
            .setCheck("var");
        this.appendValueInput('PATH')
            .appendField(Blockly.MIXLY_SD_CARD_FILE_SYSTEM_MOUNT)
            .setCheck(String);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
