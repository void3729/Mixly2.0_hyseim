...
Blockly.Blocks['communicate_irremote_receive'] = {
    init: function(){
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_GET_IRREMOTE_VALUE)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.MATH_HEX + Blockly.MIXLY_MICROBIT_TYPE_STRING, "ir_receive_hex"],
                [Blockly.MIXLY_SERIAL_WRITE, "ir_receive"]
                ]), 'op')
        this.setOutput(true,Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['communicate_irremote_send'] = {
    init: function(){
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_IR_SEND_NEC1)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.MATH_HEX + Blockly.MIXLY_MICROBIT_TYPE_STRING, "ir_send_hex"],
                [Blockly.MIXLY_SERIAL_WRITE, "ir_send"]
                ]), 'op')
...
Blockly.Blocks['communicate_wireless_socket_init'] = {
    init: function() {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendValueInput('SUB')
            .appendField(Blockly.MIXLY_WIRELESS_SOCKET + Blockly.MIXLY_SETUP)
            .setCheck("var");
        this.appendValueInput("ON")
            .appendField(Blockly.MIXLY_PIN)
            .appendField(Blockly.MIXLY_ON)
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT);
        this.appendValueInput("OFF")
            .appendField(Blockly.MIXLY_OFF)
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks.communicate_wireless_socket_on_off = {
    init: function () {
        this.setColour(Blockly.Blocks.communicate.HUE);
        this.appendDummyInput()
            .appendField(Blockly.MIXLY_WIRELESS_SOCKET)
