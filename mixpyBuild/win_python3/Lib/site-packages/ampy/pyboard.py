...
class Pyboard:
    def __init__(self, device, baudrate=115200, user='micro', password='python', wait=0, rawdelay=0, boardreset="{}"):
    ...
    def enter_raw_repl(self):
        ...
        time.sleep(0.1)
        self.serial.write(b"f = open(\'main.py\', \'w\')\r\n")
        time.sleep(0.1)
        self.serial.write(b"f.write(\'\')\r\n")
        time.sleep(0.1)
        sys.stdout.write("Empty ./main.py Done!\n")
        sys.stdout.flush()
        #print("Empty main.py done!")
...
def main():
    ...
    cmd_parser.add_argument('-sr', '--setrest', default=0x33, help='default=0x33')
